...
class locations extends Admin_Controller 
{
	...
	/* 
    * It only redirects to the manage locations page
    */
	...
	*/
	public function fetchlocationsDataById($id) 
	{
		if($id) {
			$data = $this->model_locations->getlocationsData($id);
	...
	*/
	public function fetchlocationsData()
	{
		...
		$data = $this->model_locations->getlocationsData();
	...
	public function update($id)
	{
		...
		if($id) {
	        ...
	        if ($this->form_validation->run() == TRUE) {
	        	...
	        	$update = $this->model_locations->update($data, $id);
	        	if($update == true) {
	        		$response['success'] = true;
    ...
    */
	public function remove()
	{
		...
		$response = array();
		if($store_id) {
			$delete = $this->model_locations->remove($store_id);
			if($delete == true) {
				$response['success'] = true;
