          ...
          <form role="form" action="<?php base_url('users/update') ?>" method="post" enctype="multipart/form-data">
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <input type="name" class="form-control" id="sku" name="sku" placeholder="Enter Barcode Number" value="<?php echo $product_data['sku']; ?>" autocomplete="off" />
              </div>

              <div class="form-group">
                <label for="qty_warehouse">Qty_Warehouse</label>
                <input type="number" class="form-control" id="qty_warehouse" name="qty_warehouse" placeholder="Enter Warehouse Quantity" value="<?php echo $product_data['qty_warehouse']; ?>" autocomplete="off" />
              </div>

              <div class="form-group">
                <label for="qty_store">Qty_Store</label>
                <input type="number" class="form-control" id="qty_store" name="qty_store" placeholder="Enter Store Quantity" value="<?php echo $product_data['qty_store']; ?>" autocomplete="off" />
              </div>
